...
?>
      ...
      <div class="right_col" role="main">
        <div class="">
          <div class="page-title">
            <div class="title_left">
				<h3>
                    Quick Analysis - International News
                </h3>
            </div>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Top 10 2-Words Phrases<small>click on the bars for more information</small></h2>
                  <ul class="nav navbar-right panel_toolbox">
                    <li><a class=""><i class="fa"></i></a>
                    </li>
					<li><a class=""><i class="fa"></i></a>
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
              <div class="x_panel">
				...
				<div class="x_content">
					...
					<br>
					<a href="detailed_statistics_int.php
						<?php if(!isset($_GET['startDate'])){ 
						echo "";
						} else {
					...
					<form action="quick_analysis_int.php" method="GET">
						From 
		...
		<div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Top 10 3-Words Phrases<small>click on the bars for more information</small></h2>
                  <ul class="nav navbar-right panel_toolbox">
                    <li><a class=""><i class="fa"></i></a>
                    </li>
					<li><a class=""><i class="fa"></i></a>
  ...
  <script>
	...
	?>
    // Bar chart
	var json = <?php get_analysis_data_int($startDate, $endDate, null, 10); ?>;
    ...
    // Pie chart
	var json = <?php get_source_data_int($startDate, $endDate, 20); ?>;
	var data_term = json.term;
	var data_count = json.count;
	...
	// Bar chart2
	var json = <?php get_analysis_data_int($startDate, $endDate, 2, 10); ?>;
	var data_term = json.term;
	var data_count = json.count;
	...
	ctx.innerHTML = "They also have been all over about <b>'" + json.term[0] + "'</b>, <b>'"+json.term[1]+"'</b>, and <b>'" +json.term[2] +"'</b>!";
	 ...
	 // Bar chart3
	var json = <?php get_analysis_data_int($startDate, $endDate, 3, 10); ?>;
	var data_term = json.term;
	var data_count = json.count;
