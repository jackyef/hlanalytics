...
?>
        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
				<h3>
                    Word Trends - International News
                </h3>
            </div>
          ...
          <div class="clearfix"></div>
			<div class="row">
              <div class="x_panel">
				<form action="word_trends_int.php" method="GET">
  ...
  <script>
    ...
    // Line chart
	<?php if($keyword != null){ ?>
	var json = <?php get_trend_data_int($keyword, $startDate, $endDate); ?>;
	...
	<?php } ?>
	<?php if($keyword != null) { ?>
	var raw8 = <?php get_apriori_frequent_items_int($keyword, $startDate, $endDate); ?>;
	...
	$(document).ready(function() {
	  ...
	  <?php } ?>
	<?php if($keyword != null) { ?>
	var raw7 = <?php get_headlines_int_containing($startDate, $endDate, $keyword); ?>;
